...
gles2_rendersw::gles2_rendersw(int width, int height)
...
void gles2_rendersw::render(const render_primitive_list& primlist)
{
...
void gles2_rendersw::on_viewport_change(int width, int height)
{
	m_width = width;
	m_height = height;
